...
create table doctor (id bigint not null auto_increment, enrollment varchar(255) not null, fist_name varchar(255) not null, last_name varchar(255) not null, specialty_id bigint not null, user_id bigint, primary key (id)) engine=InnoDB;
...
alter table user add constraint FKn82ha3ccdebhokx3a8fgdqeyy foreign key (role_id) references role (id);create table day (id bigint not null auto_increment, name varchar(255) not null, primary key (id)) engine=InnoDB
create table diagnostic (id bigint not null auto_increment, description varchar(255), turn_id bigint not null, primary key (id)) engine=InnoDB
create table doctor (id bigint not null auto_increment, enrollment varchar(255) not null, fist_name varchar(255) not null, last_name varchar(255) not null, specialty_id bigint not null, user_id bigint, primary key (id)) engine=InnoDB
create table role (id bigint not null auto_increment, role varchar(255) not null, primary key (id)) engine=InnoDB
create table schedule (id bigint not null auto_increment, hour_since time not null, hour_to time not null, day_id bigint not null, doctor_id bigint not null, primary key (id)) engine=InnoDB
